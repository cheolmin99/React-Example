...
import { Typography, Box ,Button, TextField ,FormControl, InputLabel, Input, InputAdornment ,IconButton} from '@mui/material'
...
export default function SignUpCardView({ setLoginView }: Props) {
  ...
  return (
    <Box display='flex' sx={{height: '100%', flexDirection: 'column', justifyContent: 'space-between'}}>
          ...
          <Box>
               { page === 1 && (<Button fullWidth variant='contained' size='large' sx={{mb: '20px'}} onClick={onNextButtonGandler}>다음 단계</Button>) }
